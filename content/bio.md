...
Outside academic research, I also work closely with industry. I was a **speech algorithm intern** in the **Foundation Model** team at **Li Auto**, where I worked on **Instruct TTS** based on **CosyVoice** and **LLASA**, as well as **continuous-feature-based speech synthesis** and **controllable singing voice synthesis** based on **VibeVoice** and **Ming-Omni-TTS**, for controllable, high-quality in-car voice generation.

I am also a **co-founder of Beijing Deep Logic Intelligence Technology**, where I have helped build products such as **video direct translation** and **comic-drama dubbing** from zero to one. This work spans product definition, data and model pipelines, prototype iteration, delivery feedback loops, and client-facing validation, connecting speech algorithms with real ToB/C product scenarios.
